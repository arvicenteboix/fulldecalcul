...
En esta unitat veurem les funcions BUSCARV i BUSCARH, que són funcions
...
La funció **BUSCARV**, és molt útil per a trobar informació en una taula o rang de manera ràpida i eficient. Aquesta funció busca un valor en la primera columna d'un rang i retorna un valor en la mateixa fila des d'una columna que especifiquem. Aquí tens un exemple senzill:

Suposem que tenim una llista d'estudiants amb les seves notes finals i volem buscar la nota d'un estudiant específic. La nostra taula és així:
...
Ara, si volem buscar la nota de l'estudiant "Carla", utilitzarem la funció **BUSCARV** de la següent manera:
...
- **A2:B6**: És el rang on volem buscar. "Carla" s'ha de trobar en la primera columna d'aquest rang.
- **2**: És el número de columna del rang des d'on volem recuperar el valor. En aquest cas, 2 perquè la nota està en la segona columna.
- **FALS**: Indica que volem una coincidència exacta.
...
Quan introduïm aquesta fórmula, Excel buscarà "Dijous" en la primera fila del rang A1:H2 i retornarà el valor de la segona fila, que és la temperatura màxima, i en aquest cas seria **21**.
