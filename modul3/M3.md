...
Esta unitat serà breu però en este cas anem a seguir utilitzant funcions i veurem com poder traure relacions coincidents entre diferents rangs. Probablement esta siga la unitat més complexa de totes, ja que utilitzarem funcions d'una manera bastant avançada. Però no vos preocupeu que a la tasca vos demanarem exactament el que hem fet ací.
...
És possible que no entengueu el que parlarem en este apartat incialment, però és important que tingueu clar el concepte. Clar tindre clars els conceptes teòrics del que estem fem, si apliquem la fórmula suma, per exemple, és perquè sabem que els valors que estem sumant han de sumar-se.
