...
És possible que no entengueu el que parlarem en este apartat inicialment, però és important que tingueu clar el concepte. Clar tindre clars els conceptes teòrics del que estem fem, si apliquem la fórmula suma, per exemple, és perquè sabem que els valors que estem sumant han de sumar-se.
...
```
:::warning
Si ho fem d'aquesta manera, si obrim el full de càlcul amb Libreoffice calc no interepretarà bé la fórmula io no ens donarà le valor.
:::
