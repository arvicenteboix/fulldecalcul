...
![Nom del rang](img/23.png){ width=60% }
:::
...
![Filtre automàtic](img/14.png){ width=30% }
...
![Detectem fila](img/15.png){ width=70% }

I definim el format:

![Format](img/16.png){ width=70% }
...
![Enganxament especial](img/17.png){ width=80% }
